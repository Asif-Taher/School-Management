  ...
  return (
    <div className='flex-1 p-4 flex flex-col xl:flex-row gap-4'>
      ...
      <div className='w-full xl:w-2/3'>
        ...
        <div className='flex flex-col lg:flex-row gap-4'> 
            ...
            <div className='bg-lamasky py-6 px-4 rounded-md flex-1 flex gap-4'>
                <div className='w-1/3'>
                <Image src="/asif.jpg" alt='' height={144} width={144} className='w-36 h-36 rounded-full object-cover'/>
                </div>
      ...
      <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
        <Link className='p-4 rounded-md bg-lamaSkayLight' href='/'>Student's Lessons</Link>
        <Link className='p-4 rounded-md bg-lamaSkayLight' href='/'>Student's Teachers</Link>
        <Link className='p-4 rounded-md bg-lamaSkayLight' href='/'>Student's Exams</Link>
        <Link className='p-4 rounded-md bg-lamaSkayLight' href='/'>Student's Results</Link>
        <Link className='p-4 rounded-md bg-lamaSkayLight' href='/'>Student's Assignments</Link>
      </div>
      </div>
      <Announcments />
      </div>
